...
3. Admin clicks Revenue to view revenue grouped by handout.
4. Admin clicks Paid students to view paid student groups, delete records, mark handouts as given, and search inside each handout list.
