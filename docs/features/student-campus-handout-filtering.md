...
The course dropdown is narrowed in the browser after a department or level is selected, reducing the chance that a student chooses a course from another class.
