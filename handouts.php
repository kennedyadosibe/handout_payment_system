...
<main class="container py-5">
    ...
    <form class="bg-white border rounded-2 p-4 mb-4" method="get">
            ...
            <div class="col-md-3">
                ...
                <select class="form-select" id="course_id" name="course_id">
                    ...
                    <?php foreach ($courses as $course): ?>
                        <option value="<?= (int) $course['course_id'] ?>" <?= $selectedCourseId === (int) $course['course_id'] ? 'selected' : '' ?>>
    ...
    <?php if (!$handouts): ?>
        <div class="alert alert-info">No handouts match the selected class filters.</div>
    <?php endif; ?>
</main>
<?php page_footer(); ?>
